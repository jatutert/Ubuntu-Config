...
mkdir /home/$SUDO_USER/intro_infra
...
chown -f -R $SUDO_USER /home/$SUDO_USER/intro_infra
#
######################################## INSTALLATIES ###################################################
#
#
...
snap run curl -o /home/$SUDO_USER/intro_infra/install-mysqlserver.sh https://raw.githubusercontent.com/msiekmans/linux-server-scripts/main/install-mysqlserver.sh
snap run curl -o /home/$SUDO_USER/intro_infra/install-webserver.sh https://raw.githubusercontent.com/msiekmans/linux-server-scripts/main/install-webserver.sh
snap run curl -o /home/$SUDO_USER/intro_infra/install-sftpserver.sh https://raw.githubusercontent.com/msiekmans/linux-server-scripts/main/install-sftpserver.sh
chmod +x /home/$SUDO_USER/intro_infra/install-mysqlserver.sh
chmod +x /home/$SUDO_USER/intro_infra/install-webserver.sh
chmod +x /home/$SUDO_USER/intro_infra/install-sftpserver.sh
#
########################## YAML FILES Ophalen ##############################################
#
# JTU
snap run curl -s -o /home/$SUDO_USER/docker-compose/nextcloud/docker-compose.yml https://raw.githubusercontent.com/jatutert/docker-compose-yaml/main/docker-compose-nextcloud-vagrant.yml
snap run curl -s -o /home/$SUDO_USER/docker-compose/odoo/docker-compose.yml https://raw.githubusercontent.com/jatutert/docker-compose-yaml/main/docker-compose-odoo-vagrant.yml  
# Internet k8s io
snap run curl -s -o /home/$SUDO_USER/docker-compose/nginx/deployment-scale.yml https://k8s.io/examples/application/deployment-scale.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/mysql/mysql-pv.yml https://k8s.io/examples/application/mysql/mysql-pv.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/mysql/mysql-deployment.yml https://k8s.io/examples/application/mysql/mysql-deployment.yaml
# awesome compose
snap run curl -s -o /home/$SUDO_USER/docker-compose/prometheus-grafana/prometheus-grafana.yml https://raw.githubusercontent.com/docker/awesome-compose/master/prometheus-grafana/compose.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/nextcloud/nextcloud-redis-mariadb.yml https://raw.githubusercontent.com/docker/awesome-compose/master/nextcloud-redis-mariadb/compose.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/nginx/nginx-flask-mysql.yml https://raw.githubusercontent.com/docker/awesome-compose/master/nginx-flask-mysql/compose.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/nginx/nginx-flask-mongo.yaml.yml https://raw.githubusercontent.com/docker/awesome-compose/master/nginx-flask-mongo/compose.yaml
#
########################## DOCKERFILE #########################################################
#
