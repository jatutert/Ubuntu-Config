...
# Internet
snap run curl -s -o /home/$SUDO_USER/docker-compose/nginx/deployment-scale.yaml https://k8s.io/examples/application/deployment-scale.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/mysql/mysql-pv.yaml https://k8s.io/examples/application/mysql/mysql-pv.yaml
snap run curl -s -o /home/$SUDO_USER/docker-compose/mysql/mysql-deployment.yaml https://k8s.io/examples/application/mysql/mysql-deployment.yaml
#
