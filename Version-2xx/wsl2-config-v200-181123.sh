...
# Versie: 2.0.0 DEVELOP d.d. 18-11-2023
# Auteur: John Tutert
#
# ######################
# Changelog V1
...
while true; do
    ...
    echo "3. Installatie Cockpit"
    echo "4. Docker"
    echo "5. Kubernetes/MiniKube"
    echo "6. Installatie GNOME"
    echo "7. Installatie Onderwijs Tools"
    ...
    case $keuze in
        ...
        4)
            ...
            # FLASK demo
            #
            # # Nog toevoegen FLASK demo bestanden vanaf github 
            # # https://hackmd.io/@pmanzoni/r1uWcTqfU
            # https://raw.githubusercontent.com/pmanzoni/flask/master/templates/index.html
            # https://raw.githubusercontent.com/pmanzoni/flask/master/Dockerfile
            # https://raw.githubusercontent.com/pmanzoni/flask/master/app.py
