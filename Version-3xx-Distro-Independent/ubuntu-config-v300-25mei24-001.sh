...
# Versie: 3.0.0 ALPHA 0001 d.d. 25-05-2024
# Auteur: John Tutert
#
#
...
#
#
# Function maak scripts
#
# Deze functie kan pas worden uitgevoerd na de functie maak_directories 
#
function maak_scripts () {
    #
...
# OPTIE 1 Voer bijwerkt actie uit
...
# OPTIE 2 Voer scripts actie uit
...
# OPTIE 6 Voer Minikube actie uit
