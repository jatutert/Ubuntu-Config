...
#
# Versie: 1.1.0 d.d. 21-09-2023
# Auteur: John Tutert
#
# Changelog
# Unix LF ipv Windows CRLF
#
...
echo 'Jouw gebruikersnaam is' $SUDO_USER
...
sudo chmod +x /home/$SUDO_USER/pull-images.sh
...
# Ophalen YAML 
sudo curl -o /home/$SUDO_USER/docker-compose/nextcloud/docker-compose.yml https://raw.githubusercontent.com/jatutert/docker-compose-yaml/main/docker-compose-nextcloud-vagrant.yml
...
# Ophalen YAML 
curl -o /home/$SUDO_USER/docker-compose/odoo/docker-compose.yml https://raw.githubusercontent.com/jatutert/docker-compose-yaml/main/docker-compose-odoo-vagrant.yml  
...
echo 'mkdir /home/$SUDO_USER/minio' >> /home/$SUDO_USER/minio_scripts/minio-docker-run.sh
echo 'mkdir /home/$SUDO_USER/minio/data' >> /home/$SUDO_USER/minio_scripts/minio-docker-run.sh
echo 'docker run -d -p 9000:9000 -p 9001:9001 -p 9090:9090 --name minio -v /home/$SUDO_USER/minio/data:/data -e "MINIO_ROOT_USER=minio1234" -e "MINIO_ROOT_PASSWORD=minio1234" minio/minio server /data --console-address ":9001"' >>/home/$SUDO_USER/minio_scripts/minio-docker-run.sh
