...
#
rm -f /home/$SUDO_USER/LUCT-Start-Time.txt > /dev/null 2>&1
date > /home/$SUDO_USER/LUCT-Start-Time.txt
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Started by $SUDO_USER"
#
#
#
# ################################################################################
...
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 1 by $SUDO_USER"
#
if [ $(id -u) -ne 0 ]; then
    clear
    luct_display_header
    ...
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Terminated by $SUDO_USER"
    exit 1
else
    echo '## Phase 1 - Checking executing rights'
fi
...
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 2 by $SUDO_USER"
#
...
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch executing in $modus mode"
#
# #######################
# Blok 2D
# Settings
...
#
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 3 by $SUDO_USER"
#
...
#
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 4 by $SUDO_USER"
#
...
#
#
logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 5 by $SUDO_USER"
#
...
function debulx_nested_os_config () {
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 8 by $SUDO_USER"
    #
...
function debulx_nested_conteng_complete () {
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 10 by $SUDO_USER"
    #
    # ##########################################################################
    #
...
function verander_machinenaam () {
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 6 by $SUDO_USER"
    #
...
function maak_directories () {
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 7 by $SUDO_USER"
    #
    # Temporary
    #
    #
...
function git_clone_demos () {
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Start of Phase 9 by $SUDO_USER"
    #
    # Demos
...
function luct_finish_script () {
    #
    rm -f /home/$SUDO_USER/LUCT-End-Time.txt > /dev/null 2>&1
    date > /home/$SUDO_USER/LUCT-End-Time.txt
    #
    logger "LUCT Version $Major.$Minor Build $Build Patch $Patch Finished by $SUDO_USER"
    #
    clear
    luct_display_header
    # Test modus 
