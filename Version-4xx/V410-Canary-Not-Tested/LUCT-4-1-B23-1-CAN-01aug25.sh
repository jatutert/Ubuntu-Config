...
echo ''
echo 'Gezamelijke functies Debian en Ubuntu'
echo ''
#
#
#
...
if [ $distro == "debian" || $distro == "ubuntu" ]; then
    ...
    if [ $actie == "upgrade" ]; then
        ...
        if [[ $distro == "debian" ]] ; then
            ...
            debulx_nested_oobe
            #
            # Installatie Open Media Vault
            echo '########## Installing Open Media Vault            ##########'
            deb_install_omv
            #
            if [ $modus == "test" ]; then
                echo 'Voor nu laten alle voorgaande meldingen even staan'
