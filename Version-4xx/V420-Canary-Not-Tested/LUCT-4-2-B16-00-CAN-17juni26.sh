...
readonly LUCT_Minor_Version_Build="16"
...
function luct_display_header () {
    printf '#########################################################################################\n'
    printf "Linux Universal Configuration Tool (LUCT) Version $LUCT_Major_Version.$LUCT_Minor_Version Build $LUCT_Minor_Version_Build Patch $LUCT_Minor_Version_Build_Patch\n"
    ...
    printf "Created by John Tutert(TutSOFT) for educational and/or personal use !\n"
    printf '#########################################################################################\n'
    printf '\n'
}
#
...
function git_clone_demos () {
    ...
    #
    # Hedy
    echo '## Phase 11 - Clone GitHub Hedy'
